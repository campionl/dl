...
class HeadMouseController:
    ...
    def update_mouse_physics(self, nose_pos):
        ...
        stable_mouth = self.get_stable_mouth_value()
    ...
    def handle_click_gestures(self, mouth_ratio):
    ...
    def draw_interface(self, frame, nose_pos, mouth_ratio):
        ...
        instructions = [
            ...
            "Bocca aperta (0.2s): Click destro",
...
def main():
    print("=" * 70)
    print("HEAD MOUSE CONTROLLER - VERSIONE SEMPLIFICATA")
    print("=" * 70)
    print("Sistema di controllo mouse tramite movimenti della testa")
    print("Controllo basato su naso e bocca (senza rilevamento occhi)")
    print("=" * 70)
    ...
    try:
        while cap.isOpened():
            ...
            if results.multi_face_landmarks:
                ...
                landmarks = {}
                required_points = ([controller.NOSE_TIP] + controller.MOUTH_POINTS)
                ...
                # Calcolo ratio per gesti
                mouth_ratio = controller.get_mouth_aspect_ratio(landmarks)
                
                # Aggiorna buffer e gestisci click
                controller.update_gesture_buffers(mouth_ratio)
                controller.handle_click_gestures(mouth_ratio)
                
                # Interfaccia utente
                controller.draw_interface(frame, nose_pos, mouth_ratio)
