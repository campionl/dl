...
class JoystickHeadMouseController:
    ...
    def _process_eye_thresholds(self):
        ...
        if self.calibration_data['left_eye_closed']:
            ...
            self.left_eye_closed_threshold = avg_left_closed + 0.01 # Add a small buffer
        ...
        if self.calibration_data['right_eye_closed']:
            ...
            self.right_eye_closed_threshold = avg_right_closed + 0.01 # Add a small buffer
        ...
        if self.calibration_data['both_eyes_closed']:
            ...
            self.both_eyes_closed_threshold = avg_both_closed + 0.01 # Add a small buffer
