...
|-----------------------------|------------------------------|----------------------------------|------------------------------------|
| **AI (LLM, Data Center)**   | ~250-300 TWh *(2024)*        | ~700 milioni litri/giorno (USA) | Crescita esponenziale              |
| **Aviazione civile globale**| ~900 TWh                     | N/A                              | L’AI può raggiungere questi livelli|
| **Industria del cemento**   | ~2.500 TWh                   | Basso                            | Emissioni CO₂ molto alte           |
| **Cloud computing (generale)** | ~600 TWh                  | Alta                             | L'AI è una porzione crescente      |
| **Agricoltura globale**     | ~4.000 TWh                   | **>70% dell’acqua mondiale**     | Dominante per uso idrico           |
| **Bitcoin e crypto**        | ~110-140 TWh                 | Molto bassa                      | Consumo energetico controverso     |
...
- **Google** (2022): 5.6 miliardi di litri d’acqua usati per i suoi data center.
- L’impatto è **particolarmente forte nelle aree già soggette a siccità**.
...
- Microsoft, Google, Meta: triplicano i data center in 5 anni.
- Sempre più modelli richiedono **cluster massivi di GPU (es. NVIDIA H100)**.
...
- Soluzioni attuali:
  - Modelli più piccoli e specializzati (es. LLaMA 3 8B)
  - Quantizzazione e distillazione
  - Infrastrutture alimentate da energie rinnovabili
...
- Serve:
  - **Trasparenza energetica** delle Big Tech
  - **Ricerca su modelli più leggeri**
  - **Politiche di sostenibilità reali**, non solo greenwashing
...
- OpenAI blog & estimate leaks
- Nature, Science (2023-2024)
